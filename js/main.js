...
(function() {
  var ASSETS, AimBullet, AimStraightMover, AimStraightShooter, BULLET_IMG, Bullet, CountLabel, Enemy, Gauge, MAP_IMG, MOVE_VEROCITY, Material, Mover, PLAYER_IMG, Player, Shooter, ShotShooter, StraightMover, StraightShooter, add, bind_new, enemies, enemy_bullets, exp_gauge, game, increment_level, intoWindow, isInWindow, level, level_label, normalize, player, player_bullets, players, puts, rand, remove, to_angle, to_angle_material, to_vec, var_dump, _ref,
    __slice = [].slice,
