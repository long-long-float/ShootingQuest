...
(function() {
  var ASSETS, AimStraightMover, BULLET_IMG, Bullet, Enemy, Material, Mover, PLAYER_IMG, Player, Shooter, StraightMover, StraightShooter, add, enemies, enemy_bullets, game, intoWindow, isInWindow, normalize, player, player_bullets, players, puts, rand, remove, to_angle, to_angle_material, to_vec,
  ...
  Material = (function(_super) {
    ...
    Material.prototype.update_rotation = function() {
      return this.rotation = to_angle(this.vx, this.vy) / Math.PI * 180;
    };
  ...
  Player = (function(_super) {
    ...
    function Player() {
      Player.__super__.constructor.call(this, PLAYER_IMG, 27, 32, 32, 2, players);
      this.scale(2, 2);
      this.rx = game.width / 2;
      this.ry = game.height / 2;
      this.core = new Material(BULLET_IMG, 20, 16, 16, 0, game.currentScene);
      this.core.scale(this.rradius * 4 / this.core.width, this.rradius * 4 / this.core.height);
  ...
  StraightShooter = (function(_super) {
    ...
    function StraightShooter(parent, way, space) {
      this.parent = parent;
      this.way = way;
      this.space = space;
      this.px = player.rx;
    ...
    StraightShooter.prototype["do"] = function() {
      ...
      angle = to_angle(this.px - this.parent.rx, this.py - this.parent.ry) + (this.way % 2 === 0 ? this.space / 2 : this.space) * Math.floor(this.way / 2);
      _results = [];
  ...
  window.onload = function() {
    ...
    game.onload = function() {
      ...
      scene.onenterframe = function() {
        var char_set, char_sets, e, first, h, i, m, p, positions, second, set, w, x, _i, _j, _k, _l, _len, _len1, _len2, _len3, _len4, _m, _n, _ref, _ref1, _ref2, _ref3, _ref4, _results;
        ...
        if (game.frame % (game.fps * rand(1, 3)) === 0) {
          ...
          for (i = _n = 0, _ref4 = rand(1, 2); 0 <= _ref4 ? _n <= _ref4 : _n >= _ref4; i = 0 <= _ref4 ? ++_n : --_n) {
            ...
            _results.push(e.mover = new AimStraightMover(e, 4, true));
          }
          return _results;
        }
      };
