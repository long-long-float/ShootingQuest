  ...
  AimStraightMover = (function(_super) {
    ...
    AimStraightMover.prototype["do"] = function() {
      ...
      if (!this.fixed) {
        ...
        _ref = to_vec(angle).map(function(v) {
          return v * _this.v;
        }), this.parent.vx = _ref[0], this.parent.vy = _ref[1];
        return alert([this.parent.vx, this.parent.vy]);
      }
    };
