...
(function() {
  var ASSETS, AimBullet, AimStraightMover, AimStraightShooter, BULLET_IMG, Bullet, Enemy, MAP_IMG, Material, Mover, PLAYER_IMG, Player, Shooter, ShotShooter, StraightMover, StraightShooter, add, bind_new, enemies, enemy_bullets, game, intoWindow, isInWindow, normalize, player, player_bullets, players, puts, rand, remove, to_angle, to_angle_material, to_vec, var_dump, _ref,
    __slice = [].slice,
      ...
      shooters = [
        {
          ...
          p: 1,
          shooter: bind_new(AimStraightShooter, bind_new(AimBullet, 4, 65), true, true)
        }, {
          p: 1,
          shooter: bind_new(AimStraightShooter, bind_new(AimBullet, 4, 65), false, true)
        }, {
          p: 1,
