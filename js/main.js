...
(function() {
  ...
  window.onload = function() {
    ...
    game.onload = function() {
      var bex, bey, floor, h, movers, positions, scene, shooters, size, w, x, y, _i, _j, _ref1, _ref2;
      ...
      scene.onenterframe = function() {
        ...
        if (game.frame % (game.fps * 2) === 0) {
          for (i = _p = 1, _ref7 = Math.max(level, 2); 1 <= _ref7 ? _p <= _ref7 : _p >= _ref7; i = 1 <= _ref7 ? ++_p : --_p) {
