...
(function() {
  ...
  AimStraightMover = (function(_super) {
    ...
    function AimStraightMover(parent, v, fixed) {
      ...
      this.fixed = fixed;
      if (this.fixed) {
        _ref = normalize(player.rx - this.parent.rx, player.ry - this.parent.ry).map(function(v) {
          return v * _this.v;
        }), this.parent.vx = _ref[0], this.parent.vy = _ref[1];
      } else {
        this.parent.vy = 1;
      }
    }
    ...
    AimStraightMover.prototype["do"] = function() {
      ...
      if (!this.fixed) {
        ...
        return _ref = to_vec(angle).map(function(v) {
          return v * _this.v;
  ...
  AimBullet = (function(_super) {
    ...
    AimBullet.prototype.onenterframe = function() {
      ...
      if (this.age === game.fps) {
        _ref = normalize(player.rx - this.rx, player.ry - this.ry).map(function(v) {
